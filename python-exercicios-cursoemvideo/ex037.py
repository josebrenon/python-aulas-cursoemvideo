"""
    ...
    Esse programa pede para o usuário digitar um número inteiro, pede para escolher qual
    base numerica quer converter, verifica qual opção ele escolheu e converte conforme a
    escolha e mostra o resultado.
